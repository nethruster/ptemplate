    ...
    return (
      <div className="pt-content-card__body pt-content-card__body__contact flex">
        <div className="pt-content-card__body__contact__social flex flex-dc flex-full-center">
          <a href="#"><div className="pt-content-card__body__contact__social__item flex flex-full-center"><Icon iconName="twitter" />&nbsp;I'm on witter</div></a>
          <a href="#"><div className="pt-content-card__body__contact__social__item flex flex-full-center"><Icon iconName="telegram" />&nbsp;I'm on Telegram</div></a>
          <a href="#"><div className="pt-content-card__body__contact__social__item flex flex-full-center"><Icon iconName="github" />&nbsp;I'm on Github</div></a>
          <a href="#"><div className="pt-content-card__body__contact__social__item flex flex-full-center"><Icon iconName="email" />&nbsp;Send an email</div></a>
        </div>
        <div className="pt-content-card__body__contact__form flex flex-main-center">
          <form className="flex flex-dc flex-full-center">
            ...
            <div className="pt-content-card__body__contact__form__row flex flex-dc flex-main-center">
              <span className="pt-content-card__body__contact__form__send-button flex flex-full-center pointer">Send&nbsp;<Icon iconName="send" /></span>
            </div>
          </form>
        </div>
      </div>
